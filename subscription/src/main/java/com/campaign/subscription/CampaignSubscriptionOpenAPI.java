...
public class CampaignSubscriptionOpenAPI {
    @Bean
    public OpenAPI campaignOpenAPI(){
        return new OpenAPI()
                .info(new Info().title("Campaign Creation & Subscription API")
                        .description("Campaign subscription for Campaign Management application")
                        .version("v0.0.1")
